...
const Index = () => {
  ...
  const sectionRefs = {
    ...
    binAttenders: useRef<HTMLElement>(null),
    customers: useRef<HTMLElement>(null),
    customerCare: useRef<HTMLElement>(null),
  };
  ...
  // Section components with highlighting
  const HomeSection = () => (
    <section 
      ref={sectionRefs.home}
      className={`relative bg-gradient-to-b from-background to-secondary/30 py-20 sm:py-32 transition-all duration-300 ${activeSection === 'home' ? 'scale-[1.01] shadow-lg shadow-eco-500/20 rounded-lg' : ''}`}
    >
  ...
  const AboutSection = () => (
    <section 
      ...
      id="about" 
      className={`py-16 sm:py-24 bg-background transition-all duration-300 ${activeSection === 'about' ? 'scale-[1.01] shadow-lg shadow-eco-500/20 rounded-lg' : ''}`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
  ...
  const BinAttendersSection = () => (
    <section 
      ref={sectionRefs.binAttenders}
      id="bin-attenders" 
      className={`py-16 sm:py-24 bg-secondary/50 transition-all duration-300 ${activeSection === 'binAttenders' ? 'scale-[1.01] shadow-lg shadow-eco-500/20 rounded-lg' : ''}`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
  ...
  const CustomersSection = () => (
    <section 
      ...
      id="customers" 
      className={`py-16 sm:py-24 bg-background transition-all duration-300 ${activeSection === 'customers' ? 'scale-[1.01] shadow-lg shadow-eco-500/20 rounded-lg' : ''}`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="md:flex md:items-center md:justify-between">
  ...
  const CustomerCareSection = () => (
    <section 
      ref={sectionRefs.customerCare}
      id="customer-care" 
      className={`py-16 sm:py-24 bg-secondary/30 transition-all duration-300 ${activeSection === 'customerCare' ? 'scale-[1.01] shadow-lg shadow-eco-500/20 rounded-lg' : ''}`}
    >
